...
export const GroqPromptHistory = mongoose.model("GroqPromptHistory", GroqPromptHistorySchema);
export const TokenTransaction = mongoose.model("TokenTransaction", TokenTransactionSchema);
export const FluvioNews = mongoose.model("FluvioNews", FluvioNewsSchema);